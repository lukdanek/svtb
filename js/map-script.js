	...
	function initialize() {
		...
		//=======================================================================================
  		var mapOptions = {
    		...
    		center: new google.maps.LatLng(50.246398,15.6421447),
			panControl: true,
  			zoomControl: true,
  			mapTypeControl: true,
  			//scaleControl: false,
		...
		var marker1 = new MarkerWithLabel({
       		position: new google.maps.LatLng(50.158817, 15.451534),
       		draggable: false,
       		raiseOnDrag: false,
       		icon: ' ',
       		map: map, 
		...
		*/	
		var marker3 = new MarkerWithLabel({
       		position: new google.maps.LatLng(50.295377, 15.867870),
       		draggable: false,
       		raiseOnDrag: false,
       		icon: ' ',
       		map: map, 
